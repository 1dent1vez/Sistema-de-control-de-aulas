...
/**
 * @descripcion  Migración para eliminar la columna class_schedule_id de gama_teacher_absences.
 *
 ...
 *
 * @cambios      2026-05-25 - Creación inicial de la migración para limpiar la columna obsoleta.
 */
...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('gama_teacher_absences', function (Blueprint $table): void {
            // Eliminar la FK, el índice y la columna class_schedule_id
